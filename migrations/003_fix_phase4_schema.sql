-- Fix grades table (add id and timestamps)
...
-- Add event_type to academic_events
ALTER TABLE academic_events ADD COLUMN IF NOT EXISTS event_type VARCHAR(50);

-- Insert sample cawu data
